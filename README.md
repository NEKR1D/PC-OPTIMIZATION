...
- There are experimental tweaks for Windows 11 that; make the OS more responsive, remove bloat, remove telemetry and adjustments to security/privacy elements.
